...
-- =====================================================
-- V20260622_01: 需求类型绑定工作流版本（一对一）
-- =====================================================
-- 说明: requirement_types.workflow_version_id 字段已在表定义中包含
-- 操作: 清空测试数据，复制 v14 工作流为 v15/v16/v17，绑定到 4 个需求类型
...
-- 重命名 v14 为"开发需求工作流"
UPDATE workflow_versions SET name = '开发需求工作流' WHERE id = 14;

-- 基于 v14 复制 3 份独立工作流
-- v15: 业务工单工作流（绑 Order 类型）
...
-- =====================================================
-- V20260625_01: 增加多维评分字段
-- =====================================================
-- 已应用到表定义中: requirement_approval_evaluations.rating_dimensions
-- 已应用到表定义中: workflow_countersign_records.rating_dimensions
...
-- =====================================================
-- V20260627_02: 工作流复制功能
-- =====================================================
-- 已应用到表定义中: workflow_versions.source_version_id, is_template, copy_count
-- 已应用到表定义中: workflow_audit_logs 表
